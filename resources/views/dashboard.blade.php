...
@section('content')
    ...
    <div class="ml-60 px-2">
        <div class="grid grid-cols-3 gap-1 sm:py-1 text-center">
            <div>
                <button
                    class="text-black border border-black focus:outline-none focus:ring-1 focus:ring-black font-Notokhmer text-xl rounded-xl px-24 py-10 text-center mr-2 mb-2 bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-10 h-10 text-center ml-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                    <div class="text-base font-Notokhmer">
                        គ្រូបង្រៀន
                        <div>
                            សរុប {{ $teacher }} នាក់
                        </div>
            ...
            <div>
                <button
                    class="py-10 px-24 mr-2 mb-2 text-xl font-Notokhmer text-black focus:outline-non rounded-xl border border-black focus:z-10 focus:ring-1 focus:ring-black bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-10 h-10 ml-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                <button
                    class=" px-24 py-10 text-black focus:outline-none focus:ring-1 focus:ring-black font-Notokhmer rounded-xl focus:z-10 text-xl mr-2 mb-2 border border-black bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-10 h-10 ml-7">
                        <path stroke-linecap="round" stroke-linejoin="round"
