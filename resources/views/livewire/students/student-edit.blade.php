            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-6 mt-3">
                <div class="mt-5 md:mt-0 md:col-span-2 border border-slate-300 rounded-xl shadow-xl">
                    <div class=" overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 flex justify-between gap-2 row items-center">
                            <div class="w-full">
                                ...
                                <input type="text" name="first_name" id="first_name" wire:model="first_name"
                                    class="form-input rounded-md w-full shadow-sm font-Notokhmer mt-1 block w-100" />
                                @error('first_name')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class=" w-full">
                                ...
                                <input type="text" name="last_name" id="last_name" wire:model="last_name"
                                    class="form-input rounded-md font-Notokhmer shadow-sm mt-1 block" />
                                @error('last_name')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
