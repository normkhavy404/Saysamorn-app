<div>
    <div class="ml-60 px-2">
        ...
        <form  wire:submit.prevent="update">
            <div class="max-w-4xl mx-auto py-1 sm:px-6 lg:px-8">
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="shadow-md border overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 flex justify-between">
                            <div>
                                <label for="first_name" class="block font-Notokhmer text-base text-black">នាមត្រកូល</label>
                                <input type="text" name="first_name" id="first_name" wire:model="first_name"
                                    class="form-input rounded-md shadow-sm font-Notokhmer mt-1 block w-100" />
                                @error('first_name')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <label for="last_name" class="block font-Notokhmer text-base text-black">នាមខ្លួន</label>
                                <input type="text" name="last_name" id="last_name" wire:model="last_name"
                                    class="form-input rounded-md font-Notokhmer shadow-sm mt-1 block w-auto" />
                                @error('last_name')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gender" class="block mb-2 text-base font-Notokhmer text-gray-900 dark:text-black">
                                ភេទ
                            </label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="dob" class="block font-Notokhmer text-base text-black">ថ្ងៃខែឆ្នាំកំណើត</label>
