        ...
        <div class="max-w-4xl mx-auto py-7 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="shadow overflow-hidden sm:rounded-md">
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="dob" class="block font-serif text-sm text-black">Date Of Birth</label>
                        <input type="date" name="email" id="email" wire:model="dob"
                            class="form-input rounded-md shadow-sm mt-1 block w-full" />
                        @error('dob')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="fa_name" class="block font-serif text-sm text-black">Father Name</label>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="dob" class="block font-serif text-sm text-black">Mother Name</label>
