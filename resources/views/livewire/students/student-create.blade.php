<div>
    <div class="ml-60 mx-2">
        ...
        <div
            class=" mt-3 inline-flex items-center px-4 py-2 bg-green-800 border border-transparent rounded-md font-Notokhmer text-base text-white hover:bg-green-900">
        ...
        <div class="max-w-4xl mx-auto py-4 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-6  border border-slate-400 rounded-lg shadow-lg">
                <div class=" overflow-hidden sm:rounded-md">
                    ...
                    <div class="px-4 py-2 bg-white sm:px-6">
                        <label for="dob" class="block font-Notokhmer text-xl text-black">ថ្ងៃខែឆ្នាំកំណើត</label>
