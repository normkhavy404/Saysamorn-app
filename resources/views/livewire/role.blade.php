<div>
    <div class="ml-60 px-2">
        ...
        <div class="py-2">
            <label for="role_name" class=" text-lg font-serif">
                Role :
            </label>
            <input type="text" name="role_name" id="role_name" wire:model="role_name">
            <button wire:click="save"
                class="px-5 py-2 border text-white font-serif rounded-sm border-blue-500 bg-blue-500">បង្កើត</button><br><br>
        </div>

        <div class="block p-6 border border-gray-300 bg-gray-100 rounded-lg shadow-lg w-full">
    ...
    <div class="ml-96 block max-w-screen-lg p-10 py-4 bg-gray-100 border border-gray-200 rounded-lg shadow-lg ">
        <ul>
            @foreach ($roles as $ro)
                <li>
