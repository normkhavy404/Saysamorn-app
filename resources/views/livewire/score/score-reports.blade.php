    ...
    <div class="ml-60">
        ...
        @if ($month || $semester)
            <div id="printMe">
                ...
                <div class="text-center text-lg font-muol font-bold">
                    <p>
                        ចំណាត់ថ្នាក់សិស្សប្រចាំ​ ​{{ $month ? 'ខែ' . filterMonth($month) : 'ឆមាស' }}
                            ...
                            <table class="w-full text-sm text-center border divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 text-black">
                                    @foreach ($studies as $sco)
                                        <tr>
                                            <td scope="col"
                                                class="px-6 py-3 text-base text-center border border-black text-gray-900">
                                                {{ $loop->index + 1 }}
                                            </td>
                                            <td scope="col"
                                            ...
                                            <td scope="col"
                                                class="px-6 py-3 text-center border border-black text-blue-600 font-bold">
                                                {{ $sco->khmer + $sco->math + $sco->science + $sco->socail }}
                                            </td>
                                            <td scope="col"
                                                class="px-6 py-3 text-base border border-black text-blue-600 font-bold">
